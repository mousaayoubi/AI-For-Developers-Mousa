/**
 * Structured JSONL logging (Part 16). Every request appends exactly one
 * line to data/logs.jsonl - easy to grep, tail, or load into the
 * evaluation harness without a database.
 */
